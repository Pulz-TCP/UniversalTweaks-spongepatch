...
public class UniversalTweaks
{
    ...
    public static final String DEPENDENCIES = "required-after:mixinbooter@[8.4,);required-after:configanytime;"
        + "after:abyssalcraft;"
    ...
    {
        if (UTConfig.BUGFIXES_ENTITIES.ENTITY_DESYNC.utEntityDesyncToggle) UTEntityDesync.initBlacklistedEntityEntries();
